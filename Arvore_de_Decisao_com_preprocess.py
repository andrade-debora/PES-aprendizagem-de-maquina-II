...
pipeline = Pipeline([('DT', DecisionTreeClassifier(criterion = 'entropy', max_depth = 5, random_state=seed)
)])
...
# definir um modelo
model = DecisionTreeClassifier(criterion = grid_search.best_params_['clf__criterion'],
...
plt.title('Curvas ROC - Decision Tree por Classe', fontsize=16)
...
plt.title("Precisão, Recall e F1-Score por Classe - Decision Tree")
plt.xlabel("Classe")
plt.ylabel("Valor")
